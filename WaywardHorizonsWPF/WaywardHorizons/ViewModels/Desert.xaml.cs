...
namespace WaywardHorizons
{
    ...
    /// </summary>
    public partial class DesertViewModel : Page
    {
        const string ViewTitle = "Desert Valley";
        ...
        public DesertViewModel(Person player, int LocationId, IUtilityService utilityService)
        {
            _player = player;
